...
\begin{itemize}
    ...
    \centering
        \centering
        \includegraphics[width=0.55\textwidth]{Imagenes/4_S&H/histeresis.png}
        \caption{Histéresis para distintas tecnologías \cite{TI2018_LF198}.}
        \label{fig: 4_histeresis}
    \end{figure}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/4_S&H/droop_rate.png}
        \caption{Droop rate.}
        \label{fig: 4_droop rate}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/4_S&H/hold_step.png}
        \caption{Hold step.}
        \label{fig : hold step}
    \end{subfigure}

    \caption{No idealidades del S\&H en función del $C_h$\cite{TI2018_LF198}.}
    \label{fig: no idealidades en funcion de Ch}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Conexiones hechas para el integrado LF398 \cite{TI2018_LF198}.}
	\label{fig: filtro}
\end{figure}
